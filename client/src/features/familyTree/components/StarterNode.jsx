...
export default function StarterNode() {
  ...
  return (
    <button
      ...
      className="relative w-[220px] rounded-3xl border border-dashed border-emerald-300 bg-white/80 p-5 text-center shadow-sm backdrop-blur transition hover:shadow-md focus:outline-none focus:ring-2 focus:ring-emerald-200"
    >
